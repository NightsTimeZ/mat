...
return Themes
	...
	Name = "Royx",
	Accent = Color3.fromRGB(72, 177, 225),

	AcrylicMain = Color3.fromRGB(20, 20, 20),
	AcrylicBorder = Color3.fromRGB(124, 186, 203),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(171, 212, 231), Color3.fromRGB(92, 121, 184)),
	AcrylicNoise = 0.98,

	TitleBarLine = Color3.fromRGB(93, 250, 255),
	Tab = Color3.fromRGB(120, 202, 199),

	Element = Color3.fromRGB(115, 206, 203),
	ElementBorder = Color3.fromRGB(107, 150, 170),
	InElementBorder = Color3.fromRGB(98, 144, 173),
	ElementTransparency = 0.87,

	ToggleSlider = Color3.fromRGB(36, 80, 160),
	ToggleToggled = Color3.fromRGB(0, 0, 0),

	SliderRail = Color3.fromRGB(141, 183, 197),

	DropdownFrame = Color3.fromRGB(134, 186, 200),
	DropdownHolder = Color3.fromRGB(69, 138, 161),
	DropdownBorder = Color3.fromRGB(69, 147, 180),
	DropdownOption = Color3.fromRGB(109, 192, 209),

	Keybind = Color3.fromRGB(90, 135, 160),

	Input = Color3.fromRGB(82, 123, 160),
	InputFocused = Color3.fromRGB(20, 10, 30),
	InputIndicator = Color3.fromRGB(106, 168, 190),

	Dialog = Color3.fromRGB(63, 96, 122),
	DialogHolder = Color3.fromRGB(59, 97, 130),
	DialogHolderLine = Color3.fromRGB(50, 74, 117),
	DialogButton = Color3.fromRGB(72, 99, 145),
	DialogButtonBorder = Color3.fromRGB(90, 105, 130),
	DialogBorder = Color3.fromRGB(74, 99, 118),
	DialogInput = Color3.fromRGB(99, 137, 159),
	DialogInputLine = Color3.fromRGB(112, 139, 167),

	Text = Color3.fromRGB(240, 240, 240),
	SubText = Color3.fromRGB(170, 170, 170),
	Hover = Color3.fromRGB(115, 150, 160),
	HoverChange = 0.04,
}
 end
} -- [RefId] = Closure
